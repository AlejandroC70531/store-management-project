 ...
 */
 ...
 ItalianFood t = new ItalianFood("t", 600, 4.99);
 ...
 */
 ...
 Pasta puttanesca = new Pasta("Spaghetti alla Puttanesca", 850, 18.99, "puttanesca", "spaghetti", false);
 ...
 */
 Pizza z = new Pizza();
 System.out.println(p.toString());
 Pizza margherita = new Pizza("Pizza Margherita", 1800, 29.99, "medium", "nothing", 8);
 ...
 */
  ...
  Gelato stracciatella = new Gelato("Stracciatella Gelato", 800, 11.99, "stracciatella", false);
